...
var Constructzilla = function(){
	...
	var homeSearch = function() {
		...
		quikSearchRemove.on('click',function() {
			jQuery('.dez-quik-search').animate({'width': '0%' ,  'left': '50%'  });
		...
		jQuery('.video').magnificPopup({
			...
			iframe: {
				markup: '<div class="mfp-iframe-scaler">'+
						 ...
						 '<div class="mfp-title">عنوان تصویر</div>'+
						 '</div>'
			},
			callbacks: {
	...
	var handleCountDown = function(WebsiteLaunchDate){
		...
		if($(".countdown").length)
		{
			$('.countdown').countdown({date: WebsiteLaunchDate+' 30 خرداد 1400 23:5'}, function() {
	...
	var handleSideBarMenu = function(){
		...
		$('.closebtn').on('click',function(e){
			...
			if($('#mySidenav1').length > 0)
			{
				document.getElementById("mySidenav1").style.right = "-1020px";
			}
